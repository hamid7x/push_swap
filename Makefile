...
#    Updated: 2026/02/06 11:43:21 by houkaamo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = push_swap.c push_swap_helper.c parse_args.c parse_utils.c ft_split.c\
      ft_atoi.c swap_op.c push_op.c rotate_op.c reverse_rotate_op.c\
      sort_small_stack.c sort_large_stack.c long_inc_sub.c cost_helper.c\
      search_helper.c move_helper.c

BONUS = checker_bonus.c parse_args_bonus.c parse_utils_bonus.c ft_atoi_bonus.c\
